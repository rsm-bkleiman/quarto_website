...
plt.plot(running_mean, color="#0f766e")
plt.axhline(true_theta, color="#a71930", linestyle="--", label="True difference = 0.04")
...
plt.axvline(theta_hat, color="#0c234b", label="Observed estimate")
...
The bootstrap standard error and the analytical standard error are very close. That means both methods are giving a similar measure of uncertainty. Using the bootstrap standard error, I can build a 95% confidence interval for the treatment effect.
...
for ax, n in zip(axes, sizes):
    ...
    ax.axvline(true_theta, color="#a71930", linestyle="--")
    ax.set_title(f"n = {n}")
